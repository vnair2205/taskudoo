<?php echo form_open(get_uri("leaves/save_leave_from_excel_file"), array("id" => "import-leave-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix import-leave-modal-body">
    <div class="container-fluid">
        <div id="upload-area">
            <?php
            echo view("includes/multi_file_uploader", array(
                "upload_url" => get_uri("uploader/upload_excel_import_file"),
                "validation_url" => get_uri("leaves/validate_import_leaves_file"),
                "max_files" => 1,
...
<div class="modal-footer">
    <?php echo anchor("leaves/download_sample_excel_file", "<i data-feather='download' class='icon-16'></i> " . app_lang("download_sample_file"), array("title" => app_lang("download_sample_file"), "class" => "btn btn-default float-start")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var $uploadArea = $("#upload-area"),
                ...
                $modalBody = $(".import-leave-modal-body"),
        ...
        function addLargeModal() {
            $ajaxModal.addClass("import-leave-app-modal");
        ...
        $submitButton.click(function () {
            $("#import-leave-form").trigger("submit");
        });
        ...
        $nextButton.click(function () {
            ...
            appLoader.show({container: ".import-leave-modal-body", css: "left:0;"});
            var $button = $(this);
