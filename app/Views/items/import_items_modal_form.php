<?php echo form_open(get_uri("items/save_item_from_excel_file"), array("id" => "import-item-form", "class" => "general-form", "role" => "form")); ?>
    ...
    <div class="container-fluid">
        <div id="upload-area">
            ...
            echo view("includes/multi_file_uploader", array(
                ...
                "validation_url" => get_uri("items/validate_import_items_file"),
                "max_files" => 1,
...
<div class="modal-footer">
    <?php echo anchor("items/download_sample_excel_file", "<i data-feather='download' class='icon-16'></i> " . app_lang("download_sample_file"), array("title" => app_lang("download_sample_file"), "class" => "btn btn-default float-start")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $nextButton.click(function () {
            ...
            $.ajax({
                url: "<?php echo get_uri('items/validate_import_items_file_data') ?>",
                type: 'POST',
                dataType: 'json',
